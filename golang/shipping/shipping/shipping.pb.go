...
func (x *ShippingItem) GetQuantity() int64 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type ShippingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EstimatedDays int64                  `protobuf:"varint,1,opt,name=estimated_days,json=estimatedDays,proto3" json:"estimated_days,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ShippingResponse) GetEstimatedDays() int64 {
	if x != nil {
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\x16.shipping.ShippingItemR\x05items\"9\n" +
	"\x10ShippingResponse\x12%\n" +
	"\x0eestimated_days\x18\x01 \x01(\x03R\restimatedDays2X\n" +
	"\bShipping\x12L\n" +
	"\x13GetDeliveryEstimate\x12\x19.shipping.ShippingRequest\x1a\x1a.shipping.ShippingResponseBHZFgithub.com/brianrafs/microservices-protofinal/golang/shipping;shippingb\x06proto3"
...
var file_shipping_shipping_proto_depIdxs = []int32{
	...
	1, // 1: shipping.Shipping.GetDeliveryEstimate:input_type -> shipping.ShippingRequest
	2, // 2: shipping.Shipping.GetDeliveryEstimate:output_type -> shipping.ShippingResponse
