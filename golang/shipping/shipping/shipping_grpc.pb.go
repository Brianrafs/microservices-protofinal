...
const (
	Shipping_GetDeliveryEstimate_FullMethodName = "/shipping.Shipping/GetDeliveryEstimate"
)
...
type ShippingClient interface {
	GetDeliveryEstimate(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error)
}
...
func (c *shippingClient) GetDeliveryEstimate(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShippingResponse)
	err := c.cc.Invoke(ctx, Shipping_GetDeliveryEstimate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServer interface {
	GetDeliveryEstimate(context.Context, *ShippingRequest) (*ShippingResponse, error)
...
func (UnimplementedShippingServer) GetDeliveryEstimate(context.Context, *ShippingRequest) (*ShippingResponse, error) {
...
func _Shipping_GetDeliveryEstimate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShippingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServer).GetDeliveryEstimate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shipping_GetDeliveryEstimate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServer).GetDeliveryEstimate(ctx, req.(*ShippingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Shipping_GetDeliveryEstimate_Handler,
		},
	},
